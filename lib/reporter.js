...
var generateReport = function (options) {
    ...
    var readedFile = fs.readFileSync(options.logo, 'base64');
    ...
    var suite = {
        ...
        logo: (options.logo) ? ('data:image/png;base64,' + readedFile) : '',
    ...
    var setStats = function (suite) {
        ...
        suite.scenarios.total = parseInt(suite.scenarios.passed) + parseInt(suite.scenarios.failed) + parseInt(suite.scenarios.skipped) + parseInt(suite.scenarios.notdefined);
        suite.total = parseInt(suite.passed) + parseInt(suite.failed);
    ...
    fs.writeFileSync(
        ...
        _.template(readFile('index.html'))({
            ...
            // logo: readFileForRespectiveTemplates('logo.txt'),
